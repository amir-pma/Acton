// Generated from C:/Users/SM T/Desktop/Phase4/Phase4/src/main/antlr\acton.g4 by ANTLR 4.7.2
package parsers;
		...
		try {
			...
			while (_la==IDENTIFIER) {
				...
				match(SEMICOLON);
				                ...
				                VarDeclaration varDeclaration = new VarDeclaration(((ActorDeclarationContext)_localctx).name.id, new ActorType(((ActorDeclarationContext)_localctx).actor.id));
				                varDeclaration.setLine(((ActorDeclarationContext)_localctx).actor.id.getLine());
				                _localctx.actordec.addKnownActor(varDeclaration);
